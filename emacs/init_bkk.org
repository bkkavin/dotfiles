 #+BEGIN_SRC emacs-lisp
     ...
     ;; (custom-set-faces
     ;;  '(default ((t (:stipple nil :background ((image :type jpeg :file "/home/bkk/Pictures/lots-of-trees.jpg") :origin display) :foreground "white" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 101 :width normal :family "misc-fixed"))))) 


   (use-package geiser-mit)
   (add-hook 'repl-mode-hook 'rainbow-delimiters-mode)
   ;; :init 
   ;;(setq geiser-mit-binary "/usr/bin/mit-scheme-x86-64")
   ;; (setq geiser-active-implementations '(mit))
 (global-set-key (kbd"C-c v") 'vterm) 
;; (global-set-key (kbd"C-c k v") '(kill-matching-buffers ("vterm"))) 
 #+END_SRC
