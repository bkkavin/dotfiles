...
myLayoutHook = spacingRaw False (Border 60 40 140 140) False (Border 20 20 20 20) True -- smart screen window  (Border top bottom right left)
            -- $ smartBorders
...
myStartupHook = do
        ...
        --      spawnAndDo (doShift "1") "urxvt"
                ...
                spawnAndDo (doShift "3") "brave-browser"    
