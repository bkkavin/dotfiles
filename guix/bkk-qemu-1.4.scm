;; This is an operating system configuration ;; This is an operating system configuration for a VM image. ;; Modify it as you see fit and instantiate the changes by running:
;;
...
(use-package-modules bootloaders certs fonts nvi gnupg disk
...
%wheel ALL=NOPASSWD: ALL\n"))
  ...
  (packages (append (list font-bitstream-vera parted gparted gnupg pinentry nss-certs nvi wget)
                    %base-packages))
